...
def run_c_program():
    ...
    result = subprocess.run(["./graphblas_example_v1"], capture_output=True, text=True)
...
def plot_bipartite_graph(matrix, coloring):
    ...
    nx.draw(G, pos, labels=node_names, font_weight='bold', node_size=1200,
            node_color=coloring, cmap=plt.cm.rainbow, font_color='black', font_size=20, ax=ax)
...
if __name__ == "__main__":
    ...
    # Plot the bipartite graph with coloring using NetworkX
