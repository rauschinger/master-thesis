...
G = nx.fast_gnp_random_graph(10, 0.3, None, True)
...
combined_matrix = np.zeros((20, 20), dtype=int)

# Fill lower left part with the original adjacency matrix
combined_matrix[10:20, 0:10] = adj_array

# Fill upper right part with the transposed adjacency matrix
combined_matrix[0:10, 10:20] = transposed_matrix
...
with open("bipartite-fast_gnp_random-20x20.txt", "w") as file:
