...
G = nx.fast_gnp_random_graph(40, 0.3, None, True)
...
combined_matrix = np.zeros((80, 80), dtype=int)

# Fill lower left part with the original adjacency matrix
combined_matrix[40:80, 0:40] = adj_array

# Fill upper right part with the transposed adjacency matrix
combined_matrix[0:40, 40:80] = transposed_matrix
...
with open("bipartite-fast_gnp_random-80x80.txt", "w") as file:
